...
describe.each([
  ...
  it("keeps recipe navigation and opens organize from the visible card button", async () => {
    ...
    expect(wrapper.getComponent(commonStubs.VCard).attributes("to")).toBe("/g/group/r/recipe");
